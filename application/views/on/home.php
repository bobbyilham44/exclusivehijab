		...
		<div class="container">
			<div class="add-products-row">
				<div class="w3ls-add-grids">
					<a href="<?php echo base_url();?>index.php/Welcome/menu"> 
	...
	<div class="wthree-order">  
		...
		<div class="container">
			<h3 class="w3ls-title">Cara Pemesanan</h3>
			<p class="w3lsorder-text">Dapatkan Makanan Favorit Hanya Dengan 4 Langkah</p>
	...
	<div class="w3agile-deals">
		<div class="container">
			<h3 class="w3ls-title">Layanan Yang Kami Tangani</h3>
			<div class="dealsrow">
				<div class="col-md-6 col-sm-6 deals-grids">
					...
					<div class="deals-right">
						...
						<p>Dapatkan layanan pengiriman gratis dengan pembelian minimal Rp 200.000,- </p>
					</div> 
					<div class="clearfix"> </div>
				</div> 
				<div class="col-md-6 col-sm-6 deals-grids">
					...
					<div class="deals-right">
						<h4>Pesta</h4>
						<p>Kami menerima pemesanan untuk segala macam pesta </p>
					</div> 
					<div class="clearfix"> </div>
				</div>
				<div class="col-md-6 col-sm-6 deals-grids">
					...
					<div class="deals-right">
						<h4>Tim</h4>
						<p>Kami menerima pembelian dengan jumlah besar </p>
					</div>
					<div class="clearfix"> </div>
				</div> 
				<div class="col-md-6 col-sm-6 deals-grids">
					...
					<div class="deals-right">
						<h4>Meeting</h4>
						<p>Kami menerima pemesanan untuk acara meeting </p>
					</div>
					<div class="clearfix"> </div>
				</div> 
				<div class="clearfix"> </div>
	...
	<div class="w3agile-spldishes">
		<div class="container">
			<h3 class="w3ls-title">Makanan Unggulan</h3>

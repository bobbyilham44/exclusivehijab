        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <form role="form" method="POST" action="<?php echo base_url()?>c_admin/updateProduk/<?php echo $edit['id_produk']?>" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label>Harga</label>
                                    <input class="form-control" name="harga" required value="<?php echo $edit['harga']?>">
                                </div>
                                <div class="form-group">
                                    <label>Gambar</label>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <textarea required class="form-control" name="deskripsi" rows="15"><?php echo $edit['deskripsi']?></textarea>
                                </div>

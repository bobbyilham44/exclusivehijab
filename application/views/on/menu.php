		...
		<div class="container">
			<div class="col-md-12 product-w3ls-right"> 
				...
				<?php
            		 foreach ($nasi as $n) {
                ?>
					<div class="col-xs-6 col-sm-3 product-grids">
						<div class="flip-container">
							<div class="flipper agile-products">
							
								<div class="front"> 
									<img src="<?php echo base_url();?>assets/images/<?= $n['image']?>" class="img-responsive" alt="">
								...
								<div class="back">
									...
									<form action="<?php echo base_url("index.php/Member/add_to_cart"); ?>" method="post">
										...
										<?=anchor('Member/detail/' . $n['id_nasi'], 'Detail' , [

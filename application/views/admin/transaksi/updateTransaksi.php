                        ...
                        <div class="col-lg-6">
                            <form role="form" method="POST" action="<?php echo base_url()?>admin/slider/editSlider/<?php echo $edit['id_slider']?>" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <input style="width:60px" class="form-control" disabled value="<?php echo $edit['id']?>" required>
                                </div>
                                <div class="form-group">
                                    <label>Customer</label>
                                    <input class="form-control" name="header1" value="<?php echo $edit['nama_lengkap']?>" required>
                                </div>
                                <div class="form-group">
